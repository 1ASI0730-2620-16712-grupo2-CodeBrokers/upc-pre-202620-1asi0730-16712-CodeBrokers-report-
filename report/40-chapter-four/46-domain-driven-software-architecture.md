...
\textbf{Step 06 - Policies}

\vspace{0.2cm}
\includegraphics[width=0.90\textwidth]{assets/461-es-step06-policies.png}
\vspace{0.15cm}
{\small Figura X+5: Step 06 - Policies}

\vspace{0.6cm}

\textbf{Step 07 - Read Models}

\vspace{0.2cm}
\includegraphics[width=0.90\textwidth]{assets/461-es-step07-read-models.png}
\vspace{0.15cm}
{\small Figura X+6: Step 07 - Read Models}

\vspace{0.6cm}

\textbf{Step 08 - External Systems}

\vspace{0.2cm}
\includegraphics[width=0.90\textwidth]{assets/461-es-step08-external-systems.png}
\vspace{0.15cm}
{\small Figura X+7: Step 08 - External Systems}

\vspace{0.6cm}

\textbf{Step 09 - Aggregates}

\vspace{0.2cm}
\includegraphics[width=0.90\textwidth]{assets/461-es-step09-aggregates.png}
\vspace{0.15cm}
{\small Figura X+8: Step 09 - Aggregates}

\vspace{0.6cm}

\textbf{Step 10 - Bounded Contexts}

\vspace{0.2cm}
\includegraphics[width=0.90\textwidth]{assets/461-es-step10-bounded-contexts.png}
\vspace{0.15cm}
{\small Figura X+9: Step 10 - Bounded Contexts}
\end{center}
```
